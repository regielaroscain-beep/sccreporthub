...
<?php $__env->startSection('title', 'Monitor Task'); ?>
    ...
    <div>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 small">
                <li class="breadcrumb-item"><a href="<?php echo e(route('admin.monitoring.index')); ?>">Maintenance Monitoring</a></li>
                <li class="breadcrumb-item active"><?php echo e($ticket->ticket_number); ?></li>
            </ol>
        </nav>
    </div>
    <div class="d-flex gap-2">
        <?php if(in_array($ticket->status, ['resolved', 'completed'])): ?>
        <a href="<?php echo e(route('admin.monitoring.receipt', $ticket)); ?>" class="btn btn-success" target="_blank">
            <i class="fas fa-print me-1"></i>Print Receipt
        </a>
        <?php endif; ?>
        <a href="<?php echo e(route('admin.monitoring.index')); ?>" class="btn btn-outline-secondary">
        ...
        <div class="card shadow-sm mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mt-3">
                    ...
                    <div class="mt-2">
                        <img src="<?php echo e($ticket->photo_url); ?>" alt="Evidence"
                ...
                <div class="timeline">
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content">
                            ...
                            <?php endif; ?>
                            <span class="badge bg-<?php echo e($log->status === 'resolved' ? 'success' : 'info'); ?> mt-1">
    ...
    <div class="col-md-4">
        ...
        <div class="card shadow-sm mb-4">
            ...
            <div class="card-body d-grid gap-2">
                ...
                <form method="POST" action="<?php echo e(route('admin.monitoring.verify', $ticket)); ?>">
                    <?php echo csrf_field(); ?>
                ...
                <a href="<?php echo e(route('admin.monitoring.receipt', $ticket)); ?>" class="btn btn-outline-success w-100" target="_blank">
                    <i class="fas fa-print me-2"></i>Generate Receipt
                </a>
                <?php elseif($ticket->status === 'ongoing'): ?>
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <div class="d-flex align-items-center gap-3">
                    <img src="<?php echo e($ticket->assignedStaff->profile_photo_url); ?>" alt="Avatar"
                         class="rounded-circle" width="48" height="48" style="object-fit:cover;"
                         onerror="this.onerror=null;this.src='https://ui-avatars.com/api/?name=<?php echo e(urlencode($ticket->assignedStaff->full_name)); ?>&background=4f46e5&color=fff&size=48'">
                    <div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\scc-reporthub\resources\views/admin/monitoring/show.blade.php ENDPATH**/ ?>