...
<div class="page-header mb-4">
    <h4 class="fw-bold mb-0"><i class="fas fa-user-edit me-2 text-primary"></i>Edit User</h4>
    <a href="<?php echo e(route('admin.users.index')); ?>" class="btn btn-outline-secondary"><i class="fas fa-arrow-left me-1"></i>Back</a>
</div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('first_name', $user->first_name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('last_name', $user->last_name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('department', $user->department)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('contact_number', $user->contact_number)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-12">
                            ...
                            <div class="mb-2">
                                <img src="<?php echo e($user->profile_photo_url); ?>" alt="Current Photo" class="rounded-circle" width="60" height="60" style="object-fit:cover;">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\scc-reporthub\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>