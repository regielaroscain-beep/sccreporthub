    ...
    <div class="receipt-body">
        <div class="d-flex justify-content-between align-items-start mb-4">
            <div>
                ...
                <div class="fw-semibold"><?php echo e(now()->format('F d, Y h:i A')); ?></div>
            </div>
            <div class="text-end">
                <div class="text-muted small">Ticket Number</div>
                <div class="fw-bold fs-5 text-primary"><?php echo e($ticket->ticket_number); ?></div>
            </div>
        </div>
        ...
        <div class="info-row">
            ...
            <div class="info-value"><?php echo e($ticket->title); ?></div>
        </div>
        <div class="info-row">
            <div class="info-label">Description</div>
            <div class="info-value"><?php echo e($ticket->description); ?></div>
        </div>
        <div class="info-row">
            <div class="info-label">Facility Location</div>
            <div class="info-value"><?php echo e($ticket->facility?->full_location ?? 'Not specified'); ?></div>
        </div>
        <div class="info-row">
            <div class="info-label">Priority Level</div>
            <div class="info-value text-capitalize fw-semibold"><?php echo e($ticket->priority_level); ?></div>
        </div>
        <div class="info-row">
            <div class="info-label">Status</div>
            <div class="info-value">
                <span class="status-badge status-completed"><?php echo e(ucfirst($ticket->status)); ?></span>
            </div>
        </div>
        <div class="info-row">
            <div class="info-label">Submitted By</div>
            <div class="info-value"><?php echo e($ticket->user->full_name); ?> — <?php echo e($ticket->user->department); ?></div>
        </div>
        <div class="info-row">
            <div class="info-label">Date Submitted</div>
            <div class="info-value"><?php echo e($ticket->created_at->format('F d, Y h:i A')); ?></div>
        </div>
        ...
        <div class="info-row">
            ...
            <div class="info-value"><?php echo e($ticket->assignedStaff?->full_name ?? '—'); ?></div>
        </div>
        <?php if($latestLog): ?>
        <div class="info-row">
            <div class="info-label">Action Taken</div>
            <div class="info-value"><?php echo e($latestLog->action_taken); ?></div>
        </div>
        <div class="info-row">
            <div class="info-label">Resolution Notes</div>
            <div class="info-value"><?php echo e($latestLog->repair_notes ?? '—'); ?></div>
        </div>
        <div class="info-row">
            <div class="info-label">Materials Used</div>
            <div class="info-value"><?php echo e($latestLog->materials_used ?? '—'); ?></div>
        </div>
        <div class="info-row">
            <div class="info-label">Repair Cost</div>
            <div class="info-value fw-bold text-success">₱<?php echo e(number_format($latestLog->repair_cost, 2)); ?></div>
        </div>
        <?php endif; ?>
        <div class="info-row">
            <div class="info-label">Completion Date</div>
            <div class="info-value"><?php echo e($ticket->completed_at?->format('F d, Y h:i A') ?? '—'); ?></div>
        </div>
        ...
        <div class="row mt-5">
            <div class="col-4 text-center">
                <div style="border-top: 1px solid #333; padding-top: 8px;">
                    ...
                    <div class="text-muted small"><?php echo e($ticket->user->full_name); ?></div>
                </div>
            </div>
            <div class="col-4 text-center">
                <div style="border-top: 1px solid #333; padding-top: 8px;">
                    <div class="small fw-semibold">Performed By</div>
                    <div class="text-muted small"><?php echo e($ticket->assignedStaff?->full_name ?? '—'); ?></div>
                </div>
            </div>
            <div class="col-4 text-center">
                <div style="border-top: 1px solid #333; padding-top: 8px;">
                    <div class="small fw-semibold">Verified By</div>
                    <div class="text-muted small"><?php echo e($ticket->approvedBy?->full_name ?? 'Administrator'); ?></div>
                </div>
            </div>
        </div>
    </div>
