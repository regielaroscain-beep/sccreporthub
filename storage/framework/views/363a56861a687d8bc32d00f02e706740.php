    ...
    <nav id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav">
            <?php if(auth()->user()->isAdmin()): ?>
                ...
                <li class="nav-item <?php echo e((request()->routeIs('admin.tickets.*') && request()->get('from') !== 'history') ? 'active' : ''); ?>">
                ...
                <li class="nav-item <?php echo e(request()->routeIs('admin.history') || request()->routeIs('admin.feedback') || request()->get('from') === 'history' ? 'active' : ''); ?>">
            ...
            <?php elseif(auth()->user()->isFaculty()): ?>
                ...
                <li class="nav-item <?php echo e((request()->routeIs('faculty.tickets.index') || request()->routeIs('faculty.tickets.show') || request()->routeIs('faculty.tickets.track')) && request()->get('from') !== 'history' ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('faculty.tickets.index')); ?>"><i class="fas fa-magnifying-glass-chart"></i> Request Monitoring</a>
                </li>
                <li class="nav-item <?php echo e(request()->routeIs('faculty.history') || request()->get('from') === 'history' ? 'active' : ''); ?>">
            ...
            <?php elseif(auth()->user()->isMaintenance()): ?>
                ...
                <li class="nav-item <?php echo e((request()->routeIs('maintenance.tasks.index') || request()->routeIs('maintenance.tasks.show')) && request()->get('from') !== 'history' ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('maintenance.tasks.index')); ?>"><i class="fas fa-screwdriver-wrench"></i> Assigned Maintenance Tasks</a>
                </li>
                <li class="nav-item <?php echo e(request()->routeIs('maintenance.tasks.completed') || request()->get('from') === 'history' ? 'active' : ''); ?>">
