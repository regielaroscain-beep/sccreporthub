...
<div class="row g-4">
    ...
    <!-- Feedback -->
    <div class="col-12 col-md-4">
        <a href="<?php echo e(route('admin.feedback')); ?>" class="text-decoration-none">
            <div class="card shadow-sm h-100 settings-card">
                <div class="card-body text-center p-4">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\scc-reporthub\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>