        ...
        <div class="card shadow-sm">
            <div class="card-body p-4">
                ...
                <div class="text-center mb-4">
                    <img src="<?php echo e(auth()->user()->profile_photo_url); ?>" alt="Avatar" class="rounded-circle mb-3"
                         width="100" height="100" style="object-fit:cover;" id="profilePreview"
                         onerror="this.src='<?php echo e(asset('images/default-avatar.png')); ?>'">
                    <div class="fw-semibold"><?php echo e(auth()->user()->full_name); ?></div>
                    <div class="text-muted small"><?php echo e(auth()->user()->role->name); ?></div>
                </div>
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('department', $user->department)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mt-4 d-flex gap-2">
                        ...
                        <a href="<?php echo e(route('password.change')); ?>" class="btn btn-outline-secondary"><i class="fas fa-key me-2"></i>Change Password</a>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\scc-reporthub\resources\views/profile/edit.blade.php ENDPATH**/ ?>