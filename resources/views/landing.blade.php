...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-si { border: none; color: var(--t2); background: transparent; padding: 7px 12px; font-size: 0.845rem; font-weight: 600; transition: color .15s; display: inline-flex; align-items: center; }
